...
Ikony na webu nepatří mezi nejpalčivější problémy, se kterými se při vývoji musíme potýkat, ale přesto lze najít několik zajímavých otázek, které je třeba zodpovědět. Jak ikony spravovat a jakým způsobem je zobrazit uživateli? Jeden přístup střídá další — každý o trochu lepší než ten předchozí, každý nějakým způsobem nedokonalý. Vrcholem této snahy je takzvaný SVG *sprite*.
